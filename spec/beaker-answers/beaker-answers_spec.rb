...
describe BeakerAnswers::Version38 do
  ...
  let(:hosts) do
    basic_hosts[0]['roles'] = %w[master agent]
    basic_hosts[1]['roles'] = %w[dashboard database agent]
