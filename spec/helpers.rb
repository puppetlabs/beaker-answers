...
module HostHelpers
  HOST_DEFAULTS = { :platform => 'unix',
                    ...
                    :box_url => 'http://default.box.url', }.freeze

  HOST_NAME     = 'vm%d'.freeze
  HOST_SNAPSHOT = 'snapshot%d'.freeze
  HOST_IP       = 'ip.address.for.%s'.freeze
  HOST_BOX      = '%s_of_my_box'.freeze
  HOST_BOX_URL  = 'http://address.for.my.box.%s'.freeze
  HOST_TEMPLATE = '%s_has_a_template'.freeze
